...
$n=0,$(window).scroll(function(){var o=$(window).scrollTop();$(window).height()-50<=o?($(".navbar-toggler").addClass("desk"),$(".navbar").addClass("light-nav"),$(".navbar").removeClass("transparent-nav"),$(".img_logo").attr("src","/static/img/logo_uzb_grey.svg")):($(".navbar-toggler").removeClass("desk"),$(".navbar").addClass("transparent-nav"),$(".navbar").removeClass("light-nav"),$(".img_logo").attr("src","/static/img/logo_uzb.svg"))}),$(".discover").click(function(){$("html, body").animate({scrollTop:$(".home-second").position().top},1e3)}),$(".play").click(function(){$(".player").trigger("play"),$(".play").css("display","none"),$(".pause").css("display","block")}),$(".pause").click(function(){$(".player").trigger("pause"),$(".play").css("display","block"),$(".pause").css("display","none")}),$(function(){$(document).ready(function(){scrollToTop(),$(".owl-one").owlCarousel(),$(".carousel-two").owlCarousel({loop:!1,items:1})})});var owl=$(".owl-one");function togglerMobile(){$(".home").length&&($hamburger=$(".home").find(".navbar-toggler"),$navCollapse=$(".home").find(".navbar-collapse"),$navbar=$(".home").find(".navbar"),$hamburger.click(function(){$n%2?($navCollapse.removeClass("mob"),$navbar.removeClass("mob")):($navCollapse.addClass("mob"),$navbar.addClass("mob")),$n++}))}function scrollToTop(){$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")})}owl.owlCarousel({loop:!0,margin:10,responsive:{0:{items:2},600:{items:3},960:{items:5},1200:{items:6}}}),owl.on("mousewheel",".owl-stage",function(o){0<o.deltaY?owl.trigger("next.owl"):owl.trigger("prev.owl"),o.preventDefault()});